...
$sql = "insert into dados_dispensa (requerente,cpf,processo,situacao,localizacao,coordenadas,dispensa,atividade,municipio,pa,bacia,captacao,lamina,data,obs,excluido) values ('$requerente','$cpf','$processo','$situacao','$localizacao','$coordenadas','$dispensa','$atividade','$municipio','$pa','$bacia','$captacao','$lamina','$data','$obs','$excluido')";
