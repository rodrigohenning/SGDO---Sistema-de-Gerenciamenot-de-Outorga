...
<?php
      if(isset($_POST['processo'])){
        ...
        $result_itens = "SELECT * FROM dados_dispensa WHERE excluido='S' and processo LIKE '%$pesquisar%' ";
    ...
    $pagina = (!empty($pagina_atual)) ? $pagina_atual : 1;
        ...
        $result_msg_contato = "SELECT * FROM dados_dispensa WHERE excluido='S'";
        ...
        //Selecionar  os itens da página
        $result_itens = "SELECT * FROM dados_dispensa WHERE excluido='S' limit $inicio, $quantidade_pg";
        $resultado_itens = mysqli_query($conexao , $result_itens);
            ...
            <table class="table">
              <thead>
                <tr>                                 
                  ...
                  <th class="text-center">NUMERO DA DISPENSA</th>
              ...
              <tbody>
                <?php while($row_itens = mysqli_fetch_assoc($resultado_itens)){?>
                  <tr>
                    ...
                    <td class="text-center"><?php echo $row_itens["dispensa"]; ?></td>
                    <td class="text-center"><?php echo $row_itens["situacao"]; ?></td>
                    
                    <td class="text-center"><?php echo "<a href='restaurar.php?id=".$row_itens['id']."'> <button  type='button' class='btn btn-primary btn-xs'>RESTAURAR</button></a>" ?></td>
                    
                    
                    <td class="text-center"><?php echo "<a href='excluir.php?id=".$row_itens['id']."'> <button  type='button' class='btn btn-danger btn-xs'>EXCLUIR</button></a>" ?></td>
