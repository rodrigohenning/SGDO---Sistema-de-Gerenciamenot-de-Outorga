...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="login.php"><span class="glyphicon glyphicon-user"></span> Area do Administrador</a></li>
    </ul>
  </div>
</nav>
...
<?php
    ...
    $pagina = (!empty($pagina_atual)) ? $pagina_atual : 1;
        ...
        $result_itens_tb = "SELECT * FROM dados_outorga WHERE excluido='N'";
        $result_itens_tbl = mysqli_query($conexao , $result_itens_tb);
        
        //Contar o total de itens
        $total_itens = mysqli_num_rows($result_itens_tbl);
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="text-center">SITUAÇAO</th>
            ...
            <li >
              ...
              echo "Página - ".$pagina_atual." de ".$num_pagina."<br>";
                if($pagina_anterior != 0){
                  ?><a href="consultar_outorga.php?pagina=$pagina_anterior<?php echo $pagina_anterior; ?>" aria-label="Previous">
            ...
            <?php
              ...
              if ($pagina_atual<($num_pagina-4)) {
                      for($i = $pagina_posterior-1; $i < $pagina_atual + 6; $i++){      
                        ?>
                          <li><a href="consultar_outorga.php?pagina=$pagina_atual<?php echo $i; ?>">
                            <?php echo $i; ?>
                          </a></li>
                        <?php
                      }
            ...
            <li>
              <?php 
                if($pagina_posterior <= $num_pagina){
                  ?><a href="consultar_outorga.php?pagina=$pagina_posterior<?php echo $pagina_posterior; ?>" aria-label="Next">
